...
public abstract class ListaGenerica<T> {
	...
	/**
	 * devuelve true si nos encontramos en el último elemento de la lista, false en
	 * caso contrario
	 */
	public abstract boolean fin();

	/**
	 * devuelve el elemento que se encuentra en la posicion pos. Hay que recordar
	 * que la lista empieza en la posicion 0.
	 * 
	 ...
	 * dicha posicion, el mismo se reubicará a continuación del elemento que vamos
	 * a agregar. Si pudo eliminarlo devuelve true, false en caso contrario.
	 * 
	...
	/**
	 * devuelve un numero que representa la cantidad de elementos que contiene la
	 * lista
	 */
	public abstract int tamanio();

	/**
	 * reemplaza el elemento en la posicion pos por el parametro elem. Devuelve true
	 * si pudo realizar el reemplazo, false en caso contrario.
	 **/
	...
	/**
	 * Devuelve una lista con una copia de los elementos de la lista generica
	...
	/**
	 * agrega todos los elementos del arreglo que recibe como par�metro y retornar
	 * true si todos ellos fueron agregados.
	 */

...
public class Banco {
	...
	/*
	 * 
	 * Por cada consulta en consultas[]: Recorro cuentas[] entre el "desde" y el
	 * "hasta" de la consulta sumando el valor
	 * 
	 */
	 ...
	 * 
	 * 2º Por cada consulta solo hago: - Sumo en la posicion "desde" el valor de la
	 * consulta - Resto en la posicion "hasta" + 1 el valor de la consulta
	 * 
	 * 3º Recorro el arreglo auxiliar - Sumo a la posicion i el valor de la
	 * posicion i-1 - Actualizo la cuenta correspondiente con el valor de aux
	 * 
	 * 
	 ...
	 * 
	 * 2º aux = [0, 3, 0, 0, 0, -3, 0, 0] --> esto indica que de la posición 1
	 * hasta el final tengo que poner un +3, el -3 en la posición 5 me lo anula
	 * cerrando el rango de actualización. aux = [0, 3, 0, 2, 0, -3, -2, 0] --> de
	 * la posicion 3 al +3 que venia arrastrando se agrega un +2, en la posición 5
	 * el +3 se anula pero sigue estando el +2 hasta que la posicion 7.
	 * 
	 * 3º aux = [0, 3, 3, 5, 5, 2, 0, 0] --> Luego de procesar aux, estos son los
	...
	public static void procesarMovimientosOptimizado(Integer[] cuentas, Consulta[] consultas) {
		...
		long tiempoFin = System.currentTimeMillis();
		System.out
				.println("procesarMovimientosOptimizado: " + ((float) (tiempoFin - tiempoInicio) / 1000) + " segundos");
	}
